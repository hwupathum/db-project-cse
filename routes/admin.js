...
router.post('/employee/add', admin_landing.check_authenticated, admin_validations.add_employee_validation, admin_landing.add_employee);

// EMPLOYEE DETAILS
router.get('/employee/:employee_id/details', admin_landing.check_authenticated, admin_landing.show_edit_employee);
router.post('/employee/:employee_id/details', admin_landing.check_authenticated, admin_validations.edit_employee_validation, admin_landing.edit_employee);
...
router.post('/employee/:employee_id/dependants/add', admin_landing.check_authenticated, admin_validations.add_departments_validation, admin_landing.add_dependants);
router.get('/employee/:employee_id/dependants/edit/:id', admin_landing.check_authenticated, admin_landing.show_edit_dependants);
router.post('/employee/:employee_id/dependants/edit/:id', admin_landing.check_authenticated, admin_validations.edit_departments_validation, admin_landing.edit_dependants);
...
router.post('/employee/:employee_id/emergency_contacts/add', admin_landing.check_authenticated, admin_validations.add_emergency_validation, admin_landing.add_emergency_contacts);
...
router.post('/employee/:employee_id/emergency_contacts/edit/:id', admin_landing.check_authenticated, admin_validations.edit_emergency_validation, admin_landing.edit_emergency_contacts);
